...
$sqlsupplier = "SELECT * FROM products ORDER BY supplier";
...
<body>
    ...
    <div class="homepage" style="margin: 5px;">
        <button class="btn" onclick="showDiv(1)"> View User</button>
        <button class="btn" onclick="showDiv(2)"> View Stock</button>
        <button class="btn" onclick="showDiv(6)"> View Supplier</button>
        <button class="btn" onclick="showDiv(3)"> View Sales</button>
        <button class="btn" onclick="showDiv(4)"> View Contact</button>
        <button class="btn" onclick="showDiv(5)"> View Feedback</button>
